...
// ─────────────────────────────────────
extern "C" void setup_x0x2ekl(void) {
    neimog_kl =
        class_new(gensym("x.kl"), (t_newmethod)kl_new, (t_method)kl_free, sizeof(kl), 0, A_GIMME, 0);
    class_addcreator((t_newmethod)kl_new, gensym("x.kl~"), A_GIMME, 0);
