...
// ─────────────────────────────────────
extern "C" void setup_x0x2eentropy(void) {
    Entropy = class_new(gensym("x.entropy"), (t_newmethod)entropy_new, 0, sizeof(EntropyObj),
                          0, A_GIMME, 0);
    class_addcreator((t_newmethod)entropy_new, gensym("x.entropy~"), A_GIMME, 0);
